...
const BANNER_DATA = {
  title: 'Welcome to the official GRUMPY CAT token fucker',
  text:
    'Because the Internet is made of cats. Because The Grumpy Cat is a legend. And because fuck you let`s have some fun.',
  button: {
...
const Banner = () => {
  const { title, text, button, button2, videoBtn, videoBtn2, bannerImage } = BANNER_DATA;
      ...
      <Container sx={styles.container}>
        <Box sx={styles.content}>
          ...
          <Box sx={styles.btnWrap}>
            <Link href={button.link} sx={styles.btn} target={'_blank'}>
              {button.label}
            </Link>
            <>
              {/* <ModalVideo
              ...
              /> */}
              <a href={videoBtn.link} target={'_blank'}>
          ...
          <Box sx={styles.btnWrap}>
            <Link href={button2.link} target={'_blank'} sx={styles.btn}>
              {button2.label}
            </Link>
            <>
              {/* <ModalVideo
