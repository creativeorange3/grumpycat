...
const WHY_CHOOSE_DATA = {
  blockTitle: {
    title: 'Why buy Grumpy Cat Token?',
    text: 'Now read carefully motherfucker',
  },
  posts: [
    {
      icon: icon1,
      title: 'Make fucking money',
      text:
        'Our chart is programmed to only go up, unless bitcoin dies - then we`re fucked',
    },
    {
      icon: icon2,
      title: 'Bitcoin',
      text:
        'You won`t get bitcoin as rewards. Congratulations!',
    },
    {
      icon: icon3,
      title: 'Work for your bags',
      text:
        'To achieve maximum potential, you will have to shill and work for your bags. Again, congratulations!',
    },
    {
      icon: icon4,
      title: 'Super Stealth Launch',
      text:
        'Stealth launched with 1 bean in liquidity. Went super smooth because devs are sexy',
    },
  ],
};
